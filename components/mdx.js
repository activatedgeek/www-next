    ...
    rehypePlugins: [
      ...
      [
        (await import("rehype-autolink-headings")).default,
        {
          ...
          content: fromHtmlIsomorphic(svgIconHtmlString, {fragment: true}).children
        },
      ],
      [
